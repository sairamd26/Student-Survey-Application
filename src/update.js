...
<div className={styles.checkboxGroup}>
    <label className={styles.checkbox}>
        <input type="checkbox" name="students" checked={ formData.students ==='true'} onChange={handleInputChange} />
        Students
    </label>
  
    <label className={styles.checkbox}>
        <input type="checkbox" name="location" checked={formData.location==='true' } onChange={handleInputChange} />
        Location
    </label>
    <label className={styles.checkbox}>
        <input type="checkbox" name="campus" checked={formData.campus==='true' } onChange={handleInputChange} />
        Campus
    </label>
    <label className={styles.checkbox}>
        <input type="checkbox" name="atmosphere" checked={formData.atmosphere==='true' } onChange={handleInputChange} />
        Atmosphere
    </label>
    <label className={styles.checkbox}>
        <input type="checkbox" name="dormRooms" checked={formData.dormRooms==='true'} onChange={handleInputChange} />
        Dorm Rooms
    </label>
    <label className={styles.checkbox}>
        <input type="checkbox" name="sports" checked={formData.sports==='true'} onChange={handleInputChange} />
        Sports
    </label>
